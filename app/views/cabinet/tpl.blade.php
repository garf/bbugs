...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="/template/common/js/metis/bootstrap/css/bootstrap.min.css">

    <!-- Font Awesome -->
    <link rel="stylesheet" href="/template/common/js/metis/font-awesome/css/font-awesome.min.css">
...
<!--jQuery 2.1.1 -->
<script src="/template/common/js/metis/jquery/jquery.min.js"></script>

<!--Bootstrap -->
<script src="/template/common/js/metis/bootstrap/js/bootstrap.min.js"></script>

<!-- Screenfull -->
<script src="/template/common/js/metis/screenfull/screenfull.js"></script>
